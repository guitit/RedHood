...
?>
    ...
    <head>
        ...
        <!--js-->
        <script src="js/objectU.js"></script>
        <!--google fonts-->
    ...
    <body class="h5">
        ...
        <li class="breadcrumbs_item">
            <a href="form1.php" class="breadcrumbs_link">Here for you</a>
        </li>
        <li class="breadcrumbs_item">
        ...
        <a href="profileU.php?id=<?php echo $Id1 ?>&idres=<?php echo $Id?>" class="edit" id="edit"><img src="images/edit.png"></a > <a href="delete.php?idres=<?php echo($row['idres'])?>" class="edit"  id="delete"><img src="images/delete.png"></a>
         ...
         <section id="map"></section>
                ...
                REDHOOD response
                    ...
                    <span><?php echo(($row['response'])? $row['response']:'Thank you for helping us create a better world! our recpiects will answer to you soon as possible.') ;?>
            </b></span>
